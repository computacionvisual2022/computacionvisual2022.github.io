...
function preload() {
  lumaShader = readShader('/workshops/exercises/Miguel Medellin/luma.frag', { varyings: Tree.texcoords2 });
  // image source: https://en.wikipedia.org/wiki/HSL_and_HSV#/media/File:Fire_breathing_2_Luc_Viatour.jpg
  img = loadImage('/workshops/exercises/Miguel Medellin/fire_breathing.jpg');
}
